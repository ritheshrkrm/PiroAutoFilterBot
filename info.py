...
BOT_TOKEN = environ.get('BOT_TOKEN', '2068749561:AAGppoXPCFaSMuDOA40az6_YOX4AGA-Kna0')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001501024994').split()]
